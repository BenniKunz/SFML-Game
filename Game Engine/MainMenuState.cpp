...
Engine::MainMenuState::MainMenuState(GameData& data)
	:_data {data}
{
...
void Engine::MainMenuState::Init()
{
	...
	_playButton = std::make_shared<PlayButton>(SCREEN_WIDTH / 2 ,300, _data, "playButton");
	_menuParts.push_back(_playButton);
