...
namespace Engine
{
	...
	public:
		...
		Item(std::shared_ptr<Player> player, ItemType type, sf::Vector2f position, std::string textureName, GameData& data, std::vector<std::shared_ptr<IGamePart>>& gameParts, int value)
